...
public final class ModItems {
    ...
    public static final DeferredItem<MeQuickTransferToolItem> ME_QUICK_TRANSFER = REG.registerItem("me_quick_transfer",
            props -> new MeQuickTransferToolItem(props.stacksTo(1)));
